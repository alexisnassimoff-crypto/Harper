...
export default async function Terminos() {
  ...
  return (
    <>
      ...
      <p>
        Realizamos envíos a todo el territorio argentino. El plazo estimado de
        entrega es de {config.plazoEntrega} desde la acreditación del pago, y
        puede variar por demoras del correo ajenas a nuestra gestión. El costo de
